...
header-includes:
   ...
   - \usepackage{eso-pic}
   - \usepackage{graphicx}
   - \newcommand\BackgroundPic{\put(0,0){\parbox[b][\paperheight]{\paperwidth}{\vfill\centering \includegraphics[width=\paperwidth,height=\paperheight, keepaspectratio]{fondo.pdf} \vfill }}}
...
knitr::include_graphics('firma.png')
```
